...
| **Offline Supported** | The core features of this app (the "Daily Putts" page in its entirety) should work entirely offline and sync to the server when possible. |
